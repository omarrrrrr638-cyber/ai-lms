const errorHandler=(err,req,res,next)=>{
  ...
  if(err.code===11000){
    ...
    message=`${field} already exosts`;statusCode=400;
  }
  ...
  if (err.code==='LIMIT_FILE_SIZE'){
    message='file size exceeds the maximum limit of 10MB';statusCode=400;
  }
...
message='Token expired';statusCode=401;
  ...
  console.error('Error:',{message:err.message,stack:process.env.NODE_ENV==='development'?err.stack:undefined});
